...
public final class Constants {
    ...
    public static final Integer MAX_BABY_AGE = 4;
    public static final Integer MIN_KID_AGE = 4;
    public static final Integer MAX_KID_AGE = 12;
    public static final Integer MIN_TEEN_AGE = 12;
    public static final Integer MAX_TEEN_AGE = 18;
    public static final Integer MAX_AVERAGE_SCORE = 10;
